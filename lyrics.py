...
def get_lyrics(artist, song_title):
    ...
    #https://www.azlyrics.com/lyrics/entershikari/mothership.html
    #https://www.azlyrics.com/lyrics/entershikari/mothersip.html
...
print("#"*20)
print(get_lyrics('Enter Shikari', 'mothership'))
